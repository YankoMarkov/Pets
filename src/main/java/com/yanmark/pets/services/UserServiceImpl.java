...
public class UserServiceImpl implements UserService {
  ...
  @Override
  public UserServiceModel saveUser(UserRegisterBindingModel userRegister) {
    if (userValidation.isValidStrings(
      ...
      throw new IllegalArgumentException(INCORRECT_FIELDS);
    }
  }

  @Override
  public UserServiceModel updateUsersRole(
    ...
    try {
      ...
      List<String> roles =
          user.getAuthorities().stream().map(UserRole::getAuthority).collect(Collectors.toList());
