...
public class UserController extends BaseController {
  ...
  public ModelAndView register(
      @ModelAttribute("userRegister") UserRegisterBindingModel userRegister) {
  ...
  public ModelAndView profile(Principal principal, ModelAndView modelAndView) {
    ...
    UserProfileViewModel userProfileViewModel =
        this.modelMapper.map(userServiceModel, UserProfileViewModel.class);
  ...
  public ModelAndView editConfirm(
      Principal principal,
      @Valid @ModelAttribute("userEdit") UserEditBindingModel userEdit,
      BindingResult bindingResult) {
    if (bindingResult.hasErrors()) {
  ...
  public ModelAndView usersAll(
      @ModelAttribute("allUsers") UserAllViewModel allUsers, ModelAndView modelAndView) {
    List<UserServiceModel> userServiceModels = this.userService.getAllUsers();
    List<UserAllViewModel> usersViewModels =
        userServiceModels.stream().map(UserAllViewModel::new).collect(Collectors.toList());
  ...
  public ModelAndView changeRole(
    ...
    UserRoleServiceModel userRoleServiceModel =
        this.userRoleService.getRoleByName(role.getAuthority());
